...
import ru.dimon6018.neko11.controls.CatControlsFragment.randomfood
import ru.dimon6018.neko11.controls.CatControlsFragment.foodstaterandom
import ru.dimon6018.neko11.controls.CatControlsFragment.randomWater
import ru.dimon6018.neko11.controls.CatControlsFragment.toyiconint
    ...
    override fun performControlAction(
        ...
        when (controlId) {
            ...
            CONTROL_ID_TOY -> {
                ...
                // TODO: re-enable toy
                Thread() {
				val meow: String = "Meow"
                    Thread.sleep((1 + Random().nextInt(4)) * 1000L)
                    NekoWorker.getExistingCat(prefs)?.let {
                    NekoWorker.notifyCat(this, it, meow)
                    }
